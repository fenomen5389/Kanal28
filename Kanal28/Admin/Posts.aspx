<%@ Page Async="true" Title="Haberler" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Posts.aspx.cs" Inherits="Kanal28.Admin.Posts" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="Body" runat="server">
    ...
    object-fit: cover;" src="<%= post.Thumbnail %>">
                                    ...
                                    <td>
                                        <i class="fa fa-eye mr-2"></i><%= post.ViewCount %>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                ...
                                                %>
                                                <a onclick="toggleCornerStone(<%= post.Id %>)" class="dropdown-item" href="#">Öne Çıkarılanlardan Kaldır</a>
                                                <%}
                                                    else
                                                    {  %>
                                                <a onclick="toggleCornerStone(<%= post.Id %>)" class="dropdown-item" href="#">Öne Çıkarılanlara Ekle</a>
                                                <%} %>
                                                ...
                                                %>
                                                <a onclick="toggleBreaking(<%= post.Id %>)" class="dropdown-item" href="#">Son Dakikadan Çıkar</a>

                                                <%}
                                                    else
                                                    {  %>
                                                <a onclick="toggleBreaking(<%= post.Id %>)" class="dropdown-item" href="#">Son Dakika Yap</a>

                                                <%} %>
                                                <a href="?Draft=<%= post.Id %>" class="dropdown-item">Taslağa Çevir</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
